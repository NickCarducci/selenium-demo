...
describe('Vote', () => {
    ...
    /*it('should display the correct title', async () => {
        await browser.url('/'); // Navigate to your app's base URL
        const title = await browser.getTitle();
        await expect(title).toEqual('Vite + React'); // Adjust based on your app's title
    });*/

    it('should vote and read results', async () => {

        await driver.get('http://localhost:4567'); // VoteLab port
        //addContext(this, { title: 'Connected', value: { key: 'status', status: 'success' } });
